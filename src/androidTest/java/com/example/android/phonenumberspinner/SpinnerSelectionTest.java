...
public class SpinnerSelectionTest {
    ...
    public void iterateSpinnerItems() {
        ...
        for (int i=0; i<size; i++) {
            ...
            //A user must click the Spinner itself in order to click any item in the Spinner.
            onView(withId(R.id.label_spinner)).perform(click());
            // Find the spinner item and click on it.
            //onData is able to first load the adapter item and bring it into focus prior
            // to locating and performing actions on any of its children.
